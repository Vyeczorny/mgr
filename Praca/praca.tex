...
\begin{tabularx}{0.92\textwidth}{ Xc } 
    \hline
    \textbf{Test}  & \textbf{Względny średni wynik} \\
    \hline
\texttt{ArrayInsertion}                                 & \textcolor{MTGreen}{-78,32 \%}    \\ 
\texttt{Fibonacci}                                      & \textcolor{MTGreen}{-45,84 \%}    \\ 
\texttt{BubbleSort}                                     & \textcolor{MTGreen}{-87,69 \%}    \\ 
\texttt{BinarySearchTree - Classis }                    & \textcolor{MTRed}{+129,29 \%}     \\ 
\texttt{BinarySearchTree - Enums }                      & \textcolor{MTRed}{+103,20 \%}     \\ 
\texttt{BinarySearchTree - Optimized}                   & \textcolor{MTGreen}{-72.09 \%}    \\ 
\texttt{DispatchMethod - Static vs Message}             & \textcolor{MTGreen}{-75,00 \%}    \\ 
\texttt{DispatchMethod - Dynamic vs Message}            & \textcolor{MTRed}{+112,79 \%}     \\ 
\texttt{Dijkstra}                                       & \textcolor{MTGreen}{-65,33 \%}    \\ 
\texttt{DijkstraOptimized}                              & \textcolor{MTGreen}{-5,14 \%}     \\ 
\texttt{WordFrequency}                                  & \textcolor{MTRed}{+157,48 \%}     \\ 
\texttt{SieveOfEratosthenes}                            & \textcolor{MTRed}{+70,94 \%}      \\ 
\texttt{CountLinesWordsChars}                           & \textcolor{MTRed}{+7718,38 \%}    \\ 
\texttt{StringConcatenation}                            & \textcolor{MTGreen}{-22,48 \%}    \\
\texttt{RGBHistogram}                                   & \textcolor{MTGreen}{-90,21 \%}    \\ 
\texttt{RC4}                                            & \textcolor{MTRed}{+116,41 \%}     \\ 
\end{tabularx}
